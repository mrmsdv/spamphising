...
def ga_ngerti():
    k1('''\033[5;32mscroll up dulu hasil dump php di atas ,scrool pelan dari atas 
kebawah
setalah itu cari tulisan <from method -blablabla- id="Email name="\033[1;31mname1\033[5;32m" nah ini yg pertama sebagai name1
setalah itu scroll pelan lagi cari name yang ke 2 id=Pass name="\033[1;31mname2\033[5;32m" nah ini yang di sebut name2
kalau VoxAvor itu sih Nicknya Calon istri Ane :v
''')
...
def pilihan1():
	  ...
	  web =inputD('url Akhir web')
          os.system("while true; do --data %s=%s&%s=%s %s; done;"%(n1,n11,n2,n21,web))
pilihan()
